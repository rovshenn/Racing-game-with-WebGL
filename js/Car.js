...
//car parts loading using JSON loader
...
/*
			var bodyFaceMaterial = Physijs.createMaterial(
				new THREE.MeshFaceMaterial( scope.bodyMaterials ),
				  .8, // high friction
				  .4 // low restitution
			);			
			
			var wheelFaceMaterial = Physijs.createMaterial(
				new THREE.MeshFaceMaterial( scope.wheelMaterials ),
				  .8, // high friction
				  .4 // low restitution
			);
	*/		
			...
			//scope.bodyMesh = new Physijs.CylinderMesh(scope.bodyGeometry, bodyFaceMaterial, 1000 );
